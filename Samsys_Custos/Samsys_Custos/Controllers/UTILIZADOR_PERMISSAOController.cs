...
namespace Samsys_Custos.Controllers
{
    public class UTILIZADOR_PERMISSAOController : Controller
    {
        ...
        {
            var applicationDbContext = _context.UTILIZADOR_PERMISSAO.Include(u => u.PERMISSAO).Include(u => u.UTILIZADOR);
        ...
        {
            ViewData["id_permissao"] = new SelectList(_context.PERMISSAO, "id_permissao", "id_permissao");
        ...
        public async Task<IActionResult> Create([Bind("id_utilizador_permissao,id_colaborador,id_permissao")] UTILIZADOR_PERMISSAO uTILIZADOR_PERMISSAO)
        {
            ...
            ViewData["id_permissao"] = new SelectList(_context.PERMISSAO, "id_permissao", "id_permissao", uTILIZADOR_PERMISSAO.id_permissao);
            ViewData["id_colaborador"] = new SelectList(_context.UTILIZADOR, "id_colaborador", "id_colaborador", uTILIZADOR_PERMISSAO.id_colaborador);
            return View(uTILIZADOR_PERMISSAO);
        }
