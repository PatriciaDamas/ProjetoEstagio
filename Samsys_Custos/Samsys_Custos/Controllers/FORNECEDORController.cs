    ...
    public class FORNECEDORController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var fORNECEDOR = await _context.FORNECEDOR
                ...
                .SingleOrDefaultAsync(m => m.id_fornecedor == id);
            if (fORNECEDOR == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var fORNECEDOR = await _context.FORNECEDOR.SingleOrDefaultAsync(m => m.id_fornecedor == id);
            if (fORNECEDOR == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_fornecedor,sugestao_categoria,sugestao_custo,nome")] FORNECEDOR fORNECEDOR)
        {
